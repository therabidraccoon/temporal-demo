...
public class CaricoArticoliWorker {
    ...
    public void init() {
        ...
        Worker worker = factory.newWorker(MagazzinoTasks.CARICO.name() + Constants.QUEUE);
        // This Worker hosts both Workflow and Activity implementations.
        // Workflows are stateful so a type is needed to create instances.
        worker.registerWorkflowImplementationTypes(CaricoArticoliWorkflowImpl.class);
