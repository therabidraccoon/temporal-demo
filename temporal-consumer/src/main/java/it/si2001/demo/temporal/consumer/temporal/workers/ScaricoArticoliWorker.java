...
import it.si2001.demo.temporal.consumer.temporal.workflow.impl.ScaricoArticoliWorkflowImpl;
...
public class ScaricoArticoliWorker {
    ...
    public void init() {
        ...
        Worker worker = factory.newWorker(MagazzinoTasks.SCARICO.name() + Constants.QUEUE);
        // This Worker hosts both Workflow and Activity implementations.
        // Workflows are stateful so a type is needed to create instances.
        worker.registerWorkflowImplementationTypes(ScaricoArticoliWorkflowImpl.class);
